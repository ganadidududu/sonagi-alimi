...
export function Phone({ src, alt = "", style, hideEmpty }: FrameProps) {
  ...
  return (
    <div style={{ position: "relative", aspectRatio: "1022 / 2082", ...style }}>
      ...
      >
        {resolved ? (
          // NOTE: `object-fit: cover` is not rendered by html-to-image's SVG
          // foreignObject rasterizer, so exports came out with a black (#111)
          // screen. Full-screen captures already match the screen aspect
          // (~0.3% off), so a plain stretched fill is visually identical and
          // exports reliably.
          <img
            src={resolved}
            alt={alt}
